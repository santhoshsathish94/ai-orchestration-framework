...
- **Proof before trust.** Autonomy should be earned against evidence, not assumed from capability. The framework makes each increase in what AI decides conditional on outcomes of that kind having repeatedly held up.
