...
- **The author** — there is a second sub-page, `site/author/index.html`, alongside the glossary. It
  ...
  links to it on every page, and the footer links to it as well. **The clover mark is
...
There is no author section on the home page. The nav and the footer link to `author/` instead.
