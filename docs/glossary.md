...
| **Execution** | AI applies its capability to system Context and human Direction, determines how the work should happen, and executes within the defined boundaries. |
