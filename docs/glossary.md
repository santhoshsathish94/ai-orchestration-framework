...
|---|---|
| **Clover** | This framework. Clover is a way of working with System, Human, and AI to produce meaningful outcomes through real Context, human Direction, delegated Action, and validated Success. See [the framework](04-framework.md). |
...
| **The common clover** | Three leaves: Direction, Action, Success. A common way of working where context is mostly what a human provides. |
