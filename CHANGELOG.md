...
- `docs/reference-implementations.md` — practical, adoptable patterns for cross-team knowledge access and production exception remediation.
- Reference visuals for both implementations.
...
- Reframed the core AI orchestration lifecycle as **Opportunity → Understand → Plan → Execute → Proof → Grow**.
- Made context, ownership, evidence, and feedback cross-cutting principles around the lifecycle rather than adding more orchestration stages.
- Added reference applications for production exception remediation and cross-team knowledge access under the core model.
